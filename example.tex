...
In this paper, we consider buffer allocation problem for line with a series-parallel network. 
An example of a line, stuctured as
 a series-parallel network shown in Fig. ~\ref{lineexample}, where $M_1,…,M_7$ are machines and $B_0,…,B_5$ are buffers.
...
To verify the ``massif central'' structure, we delevoped a method 
