...
number of admissible solutions $\mid \Omega \mid$ in sphere containing all found
local optima. 
In our case, radius of the sphere equal to distance in metric $l_1$ from best local optimum found to worst.
