...
%	\hspace{1.6em} \includegraphics[width=5.3cm, height=3.5cm]{gals_klaster}
  \caption{Final population of the GA with local optimization heuristic on instance as.4 \label{fig:gals_klaster} (note that the horizontal scale is different from 
